...
const PerfAnalytics = () => {
  ...
  const [isProductModalVisible, setIsProductModalVisible] = React.useState(
    false,
  )
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1.5, flexDirection: 'column' }}>
                <View style={{ flex: 1, flexDirection: 'column' }}>
                  <Text
                    style={[
                      styles.reportTextDesc,
                      { fontSize: normalize(11.3), flex: 1 },
                    ]}
                  >
                    Units:
                  </Text>
            ...
            <View style={{ flex: 3 }}>
              <View style={styles.reportTitleContainer}>
                <Text style={styles.reportTitle}>
                  BOTTOM STEAM PLATTENA ASSY : XF-23193
                </Text>
              </View>
              <View
                style={{
              ...
              >
                <View style={styles.reportTextContainer}>
                  <Text style={styles.reportTextDesc}>Profit:</Text>
                  <Text style={styles.reportTextNum}>13.7%[Rs.12,34,450]</Text>
                </View>
              </View>
              <View
                style={{ flexDirection: 'column', flex: 1, marginLeft: '3%' }}
              >
                <View style={styles.reportTextContainer}>
                  <Text
                    style={[
                  ...
                  <Text
                    style={[styles.reportTextNum, { fontSize: normalize(12) }]}
                  >
                    Rs.12,34,450
                  </Text>
                </View>
        ...
        >
          ...
          >
            <View style={{ flex: 3 }}>
              ...
              >
                <View style={styles.reportTextContainer}>
                  <Text style={styles.reportTextDesc}>Total Expense:</Text>
                  <Text style={styles.reportTextNum}>13.7%[Rs.12,34,450]</Text>
                </View>
              </View>
              <View
              ...
              >
                <View style={styles.reportTextContainer}>
                  <Text
                    style={[styles.reportTextDesc, { fontSize: normalize(12) }]}
                  >
                    Material Cost:
                  </Text>
                  <Text
